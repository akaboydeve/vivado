...
HD_PWD='C:/New folder/vivado/experiment2/full_adder/full_adder/full_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source full_adder.tcl
