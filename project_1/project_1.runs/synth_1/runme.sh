...
HD_PWD='C:/Users/akash/Documents/Vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sop.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sop.tcl
