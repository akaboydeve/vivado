...
HD_PWD='C:/Users/akash/Documents/Vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sop.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sop.tcl -notrace
